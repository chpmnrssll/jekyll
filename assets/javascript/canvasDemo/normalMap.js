...
class NormalMap {
  ...
  update () {
    ...
    for (let i = 0; i < output.length; i += 4) {
      ...
      let pointR = this.pointLight.r * this.pointLight.a * reflection * attenuation
      let pointG = this.pointLight.g * this.pointLight.a * reflection * attenuation
      let pointB = this.pointLight.b * this.pointLight.a * reflection * attenuation
    ...
    this.context2D.arc(this.pointLight.x, this.pointLight.y, 5, 0, Math.PI * 2)
    this.context2D.fill()
  }
...
window.demo = new NormalMap(256, 256)
